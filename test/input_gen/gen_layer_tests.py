...
if __name__ == "__main__":
    ...
    reshape_layerfp16 = tf.keras.layers.Lambda(lambda x: reshape_tensor(x, 2, 3, 3, 3))
    record_single(reshape_layer, (2, 3, 3, 3), "reshape", input_type="float")
    record_single_fp16(reshape_layerfp16, (2, 3, 3, 3), "reshape16", input_type="float")
    inspect_file("reshape.nnlayergolden")
